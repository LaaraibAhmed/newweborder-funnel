...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ imageSrc, name, role, testimony }) => {
  return (
    <div className="w-96  flex flex-col gap-6 bg-gradient-to-t from-[#06b6d400] to-[#06b6d40f] rounded-2xl border border-[#164E63] p-6">
      ...
      <blockquote className="text-[#F3F4F6] text-left tracking-[0.005rem]">
        “{testimony}”
      </blockquote>
    </div>
  );
